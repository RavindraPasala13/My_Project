...
/* ######################################################################################################
 * Method Name: LogEventWithScreenshot
...
/* ######################################################################################################
 * Class Name: TestData
 * Description: Class to retrieve and store test data into excel files 
 * ######################################################################################################
 */
 ...
 * Description: Method to load test data from excel and assign it to script variables
 * ######################################################################################################
 */
	public static void loadData()
	{
		try
		{
			...
			//use 'found row' to verify if the specified test case exists
			String ColumnValue1;
			int foundrow = 0;
			...
			//if the test case row is not found
			if(foundrow==0)
			{
 ...
 * Description: Method to assign values of script variables to excel Sheet Test data
 * ######################################################################################################
 */
	public static void exportData()
	{
		try
		{
			...
			//get row count
			int rowcount = ws1.getLastRowNum();
			//using 'found row' variable to verify if the test case row exists
			int foundrow = 0;
			for(int j = 0;j<=rowcount;j++)
			{
				Cell cell = ws1.getRow(j).getCell(0);
 ...
 * Description: Does the setup such as Loading Data,Launching WebDriver instance at the beginning of every testcase
 * ######################################################################################################
 */
 ...
 * Description: gets the current browser specified in the run manager sheet
 * ######################################################################################################
 */
	public static String getCurrentBrowser(String currentTestCase) 
	{
		...
		try
		{
			...
			//get Row count
			int rowcount = ws1.getLastRowNum();
			//Iterate Through all rows and get the test cases which are set to true.
 ...
 * Description: get the description of the current test case from the RunManager Sheet
 * ######################################################################################################
 */
...
/* ######################################################################################################
 * Method Name: execute
 * Description: Execute the selected TestCases Dynamically using reflection API's
 * ######################################################################################################
 */
...
/* ######################################################################################################
 * Method Name: create results folder
