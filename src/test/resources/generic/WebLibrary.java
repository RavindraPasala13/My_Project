 ...
 */
	public static Boolean SelectOPtionByText(String ObjectXpath,String Option)
	{
        ...
        {
        	Highlight(ObjectXpath);
        	ObjectXpath = ObjectXpath + "/span[text()='" + Option + "']";
        	driver.findElement(By.xpath(ObjectXpath)).click();
        	wait(2);
 ...
 */
    public static void Highlight(String ObjectXpath)
	{
		try
		{
		   ...
		   {
		         js.executeScript("arguments[0].style.border='solid 4px red'", element);
		         Thread.sleep(200);
 ...
 */
	...
	//################################################################################################
		...
		public static Boolean DateSelection(String ObjectXpath, String ObjectXpath1,String ObjectXpath2, String month, String year)
		{
			boolean stepstatus = true;
			try
			{
			driver.findElement(By.xpath(ObjectXpath)).click();
			wait(200);
			Select s1=new Select(driver.findElement(By.xpath(ObjectXpath1)));
			wait(200);
			s1.selectByVisibleText("month");
			wait(200);
			Select s2=new Select(driver.findElement(By.xpath(ObjectXpath2)));
			wait(200);
		...
		public static Boolean Dropdownselection(String ObjectXpath, String ObjectXpath1, String option)
		{
			boolean stepstatus = true;
			try
			{
			...
			driver.findElement(By.xpath(ObjectXpath)).click();
			wait(200);
			List<WebElement> values=driver.findElements(By.xpath(ObjectXpath1));
			wait(20);
			for(WebElement option1:values)
			{
				wait(200);
